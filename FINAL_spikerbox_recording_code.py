...
total_time = 480.0; # time in seconds [[1 s = 20000 buffer size]] // 8 MINUTES (480 s) FOR TESTING 
max_time = 480.0; # time plotted in window [s] MUST BE EQUAL TO THE TOTAL TIME
...
name_of_file = 'example_file_FULL.txt'
np.savetxt(name_of_file, np.c_[np.real(data_plot)])
